...
namespace client
{
    public class Client
    {
        ...
        public class TCPFileSend
        {
            ...
            {
                EZConsole.WriteLine("Client", file.Length.ToString());
                try
                {
                    if (socket != null)
                    {
                ...
                {
                    EZConsole.WriteLine("Client", $"Error sending data to server via TCP: {_ex}");
                }
            }
        ...
        public class UDP
        {
            ...
            public void SendData(Packet _packet)
            {
                ...
                {
                    EZConsole.WriteLine("Client", $"Error sending data to server via UDP: {_ex}");
                }
            }
